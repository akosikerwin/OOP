...
public class Library {
	...
	private void initialize() {
		...
		JLabel Book1 = new JLabel("Don Quixote.");
		...
		JLabel Book2 = new JLabel("Lord of the Rings.");
		...
		JLabel Book3 = new JLabel("And Then There Were None.");
		...
		JLabel Author1 = new JLabel("Miguel de Cervantes.");
		...
		JLabel Author2 = new JLabel("J.R.R. Tolkien.");
		...
		JLabel Author3 = new JLabel("Agatha Christie.");
